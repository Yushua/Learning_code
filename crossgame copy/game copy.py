...
class Game:
    def __init__(self):
        ...
        # self.background = GameObjects(0, 0, self.width, self.height, self.backgroundpng)
        # self.character = GameObjects(0, 0, self.block, self.block, self.character_frontpng)
        # self.chest = GameObjects(0, 0, self.block, self.block, self.character_frontpng)
